...
public class FavoritMovieAdapter extends RecyclerView.Adapter<FavoritMovieAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final FavoritMovieAdapter.ViewHolder viewHolder, int i) {
        ...
        viewHolder.btnDetail.setOnClickListener(v -> {
            Intent btn_detailMovie = new Intent(context, DetailMovieActivity.class);
            btn_detailMovie.putExtra(DetailMovieActivity.EXTRAMOVIE, listitem.get(i));
            context.startActivity(btn_detailMovie);
        });
